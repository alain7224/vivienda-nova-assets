...
import { BarChart3, CircleDollarSign, FileSpreadsheet, LayoutDashboard, Link2, LogOut, MapPinned, PanelLeft, Plus, SlidersHorizontal, UsersRound } from "lucide-react";
...
const menuItems = [
  ...
  { icon: Link2, label: "Vista previa", path: "/admin?panel=preview" },
];
